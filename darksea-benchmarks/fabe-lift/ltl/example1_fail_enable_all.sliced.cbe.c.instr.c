...
extern void *sub_80483b4___VERIFIER_error(struct l_struct_struct_OC_State * , int  ,
                                          void * ) ;

//check this error, set right after the error call. 
int error ;
...
void *main(struct l_struct_struct_OC_State *tmp__1 , int tmp__2 , void *tmp__3 ) 
{
  ...
  {
  tmp__4 = sub_80483b4___VERIFIER_error((struct l_struct_struct_OC_State *)0, 0, tmp__3);
  error = 1;
  goto safe_return;
  safe_return: 
  return ((void *)0);
