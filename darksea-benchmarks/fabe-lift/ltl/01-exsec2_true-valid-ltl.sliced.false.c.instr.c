...
void *dummy_main(struct l_struct_struct_OC_State *tmp__1 , int tmp__2 , void *tmp__3 ) ;
...
{ 
  ...
  {
  r = LLVMCountPopulation(8UL * sizeof(a), & a);
  return (r);
}
}
void *dummy_main(struct l_struct_struct_OC_State *tmp__1 , int tmp__2 , void *tmp__3 ) 
{ 
  ...
  while (1) {
    ...
    *tmp__5 = 0;
    tmp__13 = llvm_OC_ctpop_OC_i32(tmp__12 & 255);
    tmp = tmp__13 & 1;
    *tmp__6 = tmp ^ 1;
    *tmp__7 = (tmp__12 == 0U) & 1;
    tmp___0 = tmp__12 >> 31;
