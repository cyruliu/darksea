...
void *main(struct l_struct_struct_OC_State *tmp__1 , int tmp__2 , void *tmp__3 ) 
{
  ...
  tmp__8 = tmp__7 + (tmp__5 & -16);
  tmp = tmp__8 + -4;
  *((int *)tmp) = tmp__6;
  tmp__9 = STATE_REG_RBP;
  tmp___0 = tmp__8 + -8;
  tmp__10 = (int *)tmp___0;
  *tmp__10 = tmp__9;
  tmp___1 = tmp__8 + -12;
  tmp__11 = (int *)tmp___1;
  *tmp__11 = tmp__5 + 4;
  *((int *)((int )(& seg_804a010__bss) + 8)) = 0;
  STATE_REG_RDX = 0;
  tmp__4->field2.field1 = 0;
  tmp__4->field2.field3 = 1;
  tmp__4->field2.field7 = 1;
  tmp__4->field2.field9 = 0;
  tmp__4->field2.field13 = 0;
  tmp__4->field2.field5 = 0;
  STATE_REG_RAX = 0;
  tmp__12 = *tmp__11;
  STATE_REG_RCX = tmp__12;
  tmp__13 = *tmp__10;
  STATE_REG_RBP = tmp__13;
  tmp___2 = tmp__7 + -4;
  tmp___3 = tmp___2 + tmp__12;
  tmp__14 = *((int *)tmp___3);
  STATE_REG_IP = tmp__14;
  STATE_REG_RSP = tmp__12;
  return (tmp__3);
}
}
