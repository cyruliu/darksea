...
void* main(struct l_struct_struct_OC_State* tmp__1,  int tmp__2, void* tmp__3) {
  ...
  void* tmp__17;
   int tmp__18;
   int storemerge;
   int storemerge__PHI_TEMPORARY;
   int tmp__19;
   int tmp__20;

  tmp__4 = globalState;
  tmp__5 = STATE_REG_RSP;
  tmp__6 = tmp__5 + (18446744073709551608UL);
  tmp__7 = tmp__5 + (18446744073709551592UL);
 
  tmp__8 = (&tmp__4->field2.field1);
  /* *tmp__8 = ((( int)(int)((((( int)tmp__6) < (( int)(16UL)))&1)))); */
  tmp__9 =  /*tail*/ llvm_OC_ctpop_OC_i32((((( int)tmp__7)) & 255));
 
  tmp__10 = (&tmp__4->field2.field3);
   *tmp__10 = ( (( (((( int)tmp__9))& 1))^ 1));

  tmp__11 = (&tmp__4->field2.field5);
  /* *tmp__11 = (llvm_and_u8(((( int)(llvm_lshr_u64(((tmp__6 ^ (16UL)) ^ tmp__7), (4UL))))), 1)); */
  *tmp__11 = __VERIFIER_nondet_int();
  tmp__12 = (&tmp__4->field2.field7);
  *tmp__12 = ((( int)(int)(((tmp__7 == (0UL))&1))));
  tmp__13 = tmp__7 >> (63UL);
   
  tmp__14 = (&tmp__4->field2.field9);
  *tmp__14 = ((( int)tmp__13));
  tmp__15 = tmp__6>>(63UL);
  tmp__16 = (&tmp__4->field2.field13);
  *tmp__16 = ((( int)(int)((tmp__13 ^ tmp__15)+tmp__15) == 2UL)&1);
  p = 0;
  STATE_REG_RAX = __VERIFIER_nondet_();
  tmp__17 =  /*tail*/ sub_401106___VERIFIER_nondet_int(/*UNDEF*/((struct l_struct_struct_OC_State*)/*NULL*/0), /*UNDEF*/(0UL), tmp__3);
  tmp__18 = STATE_REG_RAX;
  storemerge__PHI_TEMPORARY = tmp__18;   /* for PHI node */
  goto block_40113a;

  do {     /* Syntactic loop 'block_40113a' to make GCC happy */
block_40113a:
  storemerge = storemerge__PHI_TEMPORARY;
  tmp__19 = storemerge>>31;

  /* if (((( (storemerge == 0u)&1) | tmp__19) == 0)&1) { */
  if ((((storemerge == 0)==0) && (tmp__19 == 0))&1){
  storemerge__PHI_TEMPORARY = storemerge + (-1);   /* for PHI node */
     goto block_40113a;
  } else {
    goto block_401140;
  }
...
block_401140:
  tmp__20 =  /*tail*/ llvm_OC_ctpop_OC_i32((storemerge & 255));
  *tmp__8 = 0;
  *tmp__10 = ((((( int)tmp__20))& 1))^ 1;
  *tmp__11 = 0;
  *tmp__12 = ((( int)(int)(((storemerge == 0u)&1))));
  *tmp__14 = ((( int)tmp__19));
  *tmp__16 = 0;
   p = 1;
  goto safe_return;
