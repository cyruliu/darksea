...
{ 
  ...
  *((int *)tmp___4) = tmp__33;
  tmp__35 = tmp__34 + 47;
  tmp__42__PHI_TEMPORARY = tmp__35;
  tmp__43__PHI_TEMPORARY = tmp__32;
  goto block_401170;
  block_40117e: 
  STATE_REG_RAX = 0;
  tmp__36 = *((int *)tmp__43);
  STATE_REG_RBP = tmp__36;
  tmp___5 = tmp__43 + 8;
  tmp__37 = *((int *)tmp___5);
  STATE_REG_IP = tmp__37;
  ...
  while (1) {
    ...
    *tmp__17 = ((unsigned int )tmp___11 == 2U) & 1;
    ...
    block_401178: 
    tmp___14 = tmp__43 + -12;
    tmp__58 = *((int *)tmp___14);
    *tmp__9 = 0;
    tmp__59 = llvm_OC_ctpop_OC_i32(tmp__58 & 255);
    tmp___15 = tmp__59 & 1;
    *tmp__11 = tmp___15 ^ 1;
    *tmp__12 = 0;
    *tmp__13 = ((unsigned int )tmp__58 == 0U) & 1;
    tmp___16 = tmp__58 >> 31;
    tmp__60 = tmp___16;
    *tmp__15 = tmp__60;
    *tmp__17 = 0;
    ...
    *((int *)tmp__52) = tmp__42 + -32;
    ...
    tmp___17 = llvm_select_u64(((unsigned int )tmp__54 == 0U) & 1, 16, 2);
    tmp___18 = tmp__55 + 2;
    tmp__56 = tmp___18 + tmp___17;
    ...
    block_401154: 
    tmp___19 = tmp__57 + -4;
    tmp__38 = (int *)tmp___19;
    tmp__39 = *tmp__38;
    tmp___20 = tmp__57 + -12;
    tmp__40 = *((int *)tmp___20);
    *tmp__38 = tmp__39 + ~ tmp__40;
    tmp__41 = tmp__56 + 28;
    _2e_be__PHI_TEMPORARY = tmp__41;
    goto block_401170_2e_backedge;
    block_401162: 
    tmp___21 = tmp__57 + -8;
    tmp__61 = (int *)tmp___21;
    tmp__62 = *tmp__61;
    tmp__63 = tmp__62 + 1;
    STATE_REG_RDX = tmp__63;
    tmp___22 = tmp__57 + -12;
    tmp__64 = *((int *)tmp___22);
    tmp__65 = tmp__56 + 14;
    *tmp__61 = tmp__64 + tmp__63;
    _2e_be__PHI_TEMPORARY = tmp__65;
    goto block_401170_2e_backedge;
