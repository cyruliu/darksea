...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__55 ,
                                       int tmp__56 , void *tmp__57 ) ;
...
{ 
  ...
  int _2e_in ;
  int _2e_in__PHI_TEMPORARY ;
  int tmp__32 ;
  int tmp__32__PHI_TEMPORARY ;
  int *tmp__33 ;
  int _2e_lcssa9 ;
  int _2e_lcssa9__PHI_TEMPORARY ;
  int _2e_lcssa3 ;
  ...
  *tmp__29 = tmp__27;
  if (! ((tmp__27 > -1) & 1)) {
    _2e_lcssa9__PHI_TEMPORARY = tmp__26;
    _2e_lcssa3__PHI_TEMPORARY = tmp__27;
    goto block_40115c;
  }
  block_401139_2e_lr_2e_ph_2e_preheader: 
  tmp__30 = tmp__28 + 34;
  tmp__31__PHI_TEMPORARY = tmp__29;
  _2e_in__PHI_TEMPORARY = tmp__26;
  tmp__32__PHI_TEMPORARY = tmp__30;
  goto block_401139_2e_lr_2e_ph;
  while (1) {
    block_401139_2e_lr_2e_ph: 
    tmp__31 = tmp__31__PHI_TEMPORARY;
    _2e_in = _2e_in__PHI_TEMPORARY;
    tmp__32 = tmp__32__PHI_TEMPORARY;
    tmp___4 = _2e_in + -4;
    tmp__33 = (int *)tmp___4;
    tmp__37__PHI_TEMPORARY = tmp__32;
    goto block_401139;
    while (1) {
      block_401139: 
      ...
      *tmp__33 = tmp__39;
      tmp__40 = tmp__39 >> 31;
      tmp__41 = tmp__40;
      tmp___5 = llvm_select_u64((tmp__41 == 0) & 1, 2, 17);
      tmp___6 = tmp__37 + -21;
      tmp__42 = tmp___6 + tmp___5;
      if (! ((tmp__41 == 1) & 1)) {
        goto block_401143;
      }
      block_401152: 
      ...
      *tmp__31 = tmp__45;
      if ((tmp__45 > -1) & 1) {
        tmp__37__PHI_TEMPORARY = tmp__43;
        goto block_401139;
      } else {
        _2e_lcssa9__PHI_TEMPORARY = _2e_in;
        _2e_lcssa3__PHI_TEMPORARY = tmp__45;
        goto block_40115c;
      }
    }
    block_401143: 
    tmp__46 = llvm_OC_ctpop_OC_i32(tmp__39 & 255);
    *tmp__9 = 0;
    tmp___7 = tmp__46 & 1;
    *tmp__11 = tmp___7 ^ 1;
    *tmp__12 = 0;
    *tmp__13 = ((unsigned int )tmp__39 == 0U) & 1;
    *tmp__15 = tmp__40;
    *tmp__17 = 0;
    STATE_REG_RAX = 0;
    tmp__47 = STATE_REG_RSP;
    tmp__48 = tmp__47 + -8;
    *((int *)tmp__48) = tmp__42 + 10;
    STATE_REG_RSP = tmp__48;
    STATE_REG_RAX = __VERIFIER_nondet_int();
    tmp__50 = STATE_REG_RBP;
    tmp__51 = STATE_REG_RAX;
    tmp__52 = STATE_REG_IP;
    tmp___8 = tmp__50 + -8;
    tmp__53 = (int *)tmp___8;
    *tmp__53 = tmp__51;
    tmp__54 = tmp__52 + 9;
    if ((tmp__51 > -1) & 1) {
      tmp__31__PHI_TEMPORARY = tmp__53;
      _2e_in__PHI_TEMPORARY = tmp__50;
      tmp__32__PHI_TEMPORARY = tmp__54;
      goto block_401139_2e_lr_2e_ph;
    } else {
      _2e_lcssa9__PHI_TEMPORARY = tmp__50;
      _2e_lcssa3__PHI_TEMPORARY = tmp__51;
      goto block_40115c;
    }
  }
  block_40115c: 
  _2e_lcssa9 = _2e_lcssa9__PHI_TEMPORARY;
  _2e_lcssa3 = _2e_lcssa3__PHI_TEMPORARY;
  tmp__34 = llvm_OC_ctpop_OC_i32(_2e_lcssa3 & 255);
  *tmp__9 = 0;
  tmp___9 = tmp__34 & 1;
  *tmp__11 = tmp___9 ^ 1;
  *tmp__12 = 0;
  ...
  *tmp__17 = 0;
  STATE_REG_RAX = 0;
  tmp__35 = *((int *)_2e_lcssa9);
  STATE_REG_RBP = tmp__35;
  tmp___10 = _2e_lcssa9 + 8;
  tmp__36 = *((int *)tmp___10);
  STATE_REG_IP = tmp__36;
  STATE_REG_RSP = _2e_lcssa9 + 16;
  return (tmp__25);
}
}
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__55 ,
...
{ 
  ...
  {
  tmp__58 = STATE_REG_RBP;
  tmp__59 = STATE_REG_RSP;
  tmp = tmp__59 + -8;
  *((int *)tmp) = tmp__58;
  STATE_REG_RBP = tmp__58;
  tmp__60 = *((int *)tmp__59);
  STATE_REG_IP = tmp__60;
  STATE_REG_RSP = tmp__59 + 8;
  return (tmp__57);
}
}
