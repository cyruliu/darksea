...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__59 ,
                                       int tmp__60 , void *tmp__61 ) ;
...
{ 
  ...
  *tmp__17 = ((unsigned int )tmp___7 == 2U) & 1;
  ...
  block_401159: 
  tmp__36 = tmp__46 + -65535;
  *tmp__9 = (tmp__46 < 65535) & 1;
  tmp__37 = llvm_OC_ctpop_OC_i32(tmp__36 & 255);
  tmp___9 = tmp__37 & 1;
  *tmp__11 = tmp___9 ^ 1;
  tmp___10 = ((tmp__46 ^ 16) ^ tmp__36) >> 4;
  *tmp__12 = tmp___10 & 1;
  *tmp__13 = ((unsigned int )tmp__36 == 0U) & 1;
  tmp__38 = tmp__36 >> 31;
  tmp__39 = tmp__38;
  *tmp__15 = tmp__39;
  tmp___11 = (tmp__38 ^ tmp__51) + tmp__51;
  *tmp__17 = ((unsigned int )tmp___11 == 2U) & 1;
  tmp___12 = (tmp__38 ^ tmp__51) + tmp__51;
  if (! (((((unsigned int )tmp__36 == 0U) & 1) | ((((tmp__39 != 0) & 1) ^ (((unsigned int )tmp___12 == 2U) & 1)) & 1)) & 1)) {
    goto block_40118c;
  }
  block_401181_2e_preheader: 
  tmp__40 = *tmp__29;
  if (! ((tmp__40 > -1) & 1)) {
    _2e_lcssa1__PHI_TEMPORARY = tmp__40;
    goto block_401187;
  }
  block_401169_2e_preheader: 
  _2e_pre = *tmp__28;
  tmp__41__PHI_TEMPORARY = _2e_pre;
  tmp__42__PHI_TEMPORARY = tmp__40;
  goto block_401169;
  while (1) {
    block_401169: 
    tmp__41 = tmp__41__PHI_TEMPORARY;
    tmp__42 = tmp__42__PHI_TEMPORARY;
    *tmp__29 = tmp__41 + tmp__42;
    tmp__43 = *tmp__28;
    STATE_REG_RDX = tmp__43;
    tmp__44 = ~ (tmp__43 << 1);
    *tmp__28 = tmp__44;
    tmp__45 = *tmp__29;
    if ((tmp__45 > -1) & 1) {
      tmp__41__PHI_TEMPORARY = tmp__44;
      tmp__42__PHI_TEMPORARY = tmp__45;
      goto block_401169;
    } else {
      _2e_lcssa1__PHI_TEMPORARY = tmp__45;
      goto block_401187;
    }
  }
  block_401150: 
  tmp__46 = *tmp__28;
  tmp__47 = tmp__46 + 65535;
  *tmp__9 = (tmp__46 < -65535) & 1;
  tmp__48 = llvm_OC_ctpop_OC_i32(tmp__47 & 255);
  tmp___13 = tmp__48 & 1;
  *tmp__11 = tmp___13 ^ 1;
  tmp___14 = (tmp__47 ^ tmp__46) >> 4;
  *tmp__12 = tmp___14 & 1;
  *tmp__13 = ((unsigned int )tmp__47 == 0U) & 1;
  tmp__49 = tmp__47 >> 31;
  tmp__50 = tmp__49;
  *tmp__15 = tmp__50;
  tmp__51 = tmp__46 >> 31;
  tmp___15 = (tmp__49 ^ tmp__51) + (tmp__51 ^ 1);
  *tmp__17 = ((unsigned int )tmp___15 == 2U) & 1;
  tmp___16 = (tmp__49 ^ tmp__51) + (tmp__51 ^ 1);
  if (! ((((tmp__50 != 0) & 1) ^ (((unsigned int )tmp___16 == 2U) & 1)) & 1)) {
    goto block_401159;
  }
  block_40118c: 
  STATE_REG_RAX = 0;
  tmp__52 = *((int *)tmp__26);
  STATE_REG_RBP = tmp__52;
  tmp___17 = tmp__26 + 8;
  tmp__53 = *((int *)tmp___17);
  STATE_REG_IP = tmp__53;
  STATE_REG_RSP = tmp__26 + 16;
  return (tmp__25);
  block_401187: 
  _2e_lcssa1 = _2e_lcssa1__PHI_TEMPORARY;
  tmp__54 = llvm_OC_ctpop_OC_i32(_2e_lcssa1 & 255);
  *tmp__9 = 0;
  tmp___18 = tmp__54 & 1;
  *tmp__11 = tmp___18 ^ 1;
  *tmp__12 = 0;
  ...
  *tmp__17 = 0;
  goto block_40118c;
  block_401140: 
  tmp__55 = tmp__30 + -65535;
  *tmp__9 = (tmp__30 < 65535) & 1;
  tmp__56 = llvm_OC_ctpop_OC_i32(tmp__55 & 255);
  tmp___19 = tmp__56 & 1;
  *tmp__11 = tmp___19 ^ 1;
  tmp___20 = ((tmp__30 ^ 16) ^ tmp__55) >> 4;
  *tmp__12 = tmp___20 & 1;
  *tmp__13 = ((unsigned int )tmp__55 == 0U) & 1;
  tmp__57 = tmp__55 >> 31;
  tmp__58 = tmp__57;
  *tmp__15 = tmp__58;
  tmp___21 = (tmp__57 ^ tmp__35) + tmp__35;
  *tmp__17 = ((unsigned int )tmp___21 == 2U) & 1;
  tmp___22 = (tmp__57 ^ tmp__35) + tmp__35;
  if (((((unsigned int )tmp__55 == 0U) & 1) | ((((tmp__58 != 0) & 1) ^ (((unsigned int )tmp___22 == 2U) & 1)) & 1)) & 1) {
    goto block_401150;
  } else {
    goto block_40118c;
  }
...
{ 
  ...
  {
  tmp__62 = STATE_REG_RBP;
  tmp__63 = STATE_REG_RSP;
  tmp = tmp__63 + -8;
  *((int *)tmp) = tmp__62;
  STATE_REG_RBP = tmp__62;
  tmp__64 = *((int *)tmp__63);
  STATE_REG_IP = tmp__64;
  STATE_REG_RSP = tmp__63 + 8;
  return (tmp__61);
}
}
