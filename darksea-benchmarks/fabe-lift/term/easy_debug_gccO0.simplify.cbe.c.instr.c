...
{ 
  ...
  int *tmp__28 ;
  int tmp__29 ;
  int tmp__29__PHI_TEMPORARY ;
  int tmp__30 ;
  int tmp__30__PHI_TEMPORARY ;
  int _2e_lcssa3 ;
  ...
  *tmp__22 = tmp__21;
  ...
  block_40113a_2e_lr_2e_ph: 
  tmp___8 = tmp__20 + -8;
  tmp__28 = (int *)tmp___8;
  tmp__29__PHI_TEMPORARY = tmp__21;
  tmp__30__PHI_TEMPORARY = tmp__24;
  goto block_40113a;
  while (1) {
    block_40113a: 
    tmp__29 = tmp__29__PHI_TEMPORARY;
    tmp__30 = tmp__30__PHI_TEMPORARY;
    if (((unsigned int )tmp__29 == 0U) & 1) {
      _2e_pre_2d_phi__PHI_TEMPORARY = tmp__23;
      tmp__35__PHI_TEMPORARY = tmp__30;
      goto block_40114a_2e_backedge;
    }
    block_401146: 
    tmp__34 = *tmp__28;
    _2e_pre_2d_phi__PHI_TEMPORARY = tmp__28;
    tmp__35__PHI_TEMPORARY = tmp__34;
    goto block_40114a_2e_backedge;
    block_40114a_2e_backedge: 
    _2e_pre_2d_phi = _2e_pre_2d_phi__PHI_TEMPORARY;
    tmp__35 = tmp__35__PHI_TEMPORARY;
    *_2e_pre_2d_phi = tmp__35 + 1;
    tmp__36 = *tmp__23;
    tmp__37 = tmp__36 + -39;
    tmp__38 = tmp__37 >> 31;
    tmp__39 = tmp__36 >> 31;
    tmp___10 = (tmp__38 ^ tmp__39) + tmp__39;
    if (! (((((unsigned int )tmp__37 == 0U) & 1) | (((((unsigned int )tmp__38 != 0U) & 1) ^ (((unsigned int )tmp___10 == 2U) & 1)) & 1)) & 1)) {
      _2e_lcssa3__PHI_TEMPORARY = tmp__36;
      _2e_lcssa2__PHI_TEMPORARY = tmp__37;
      _2e_lcssa1__PHI_TEMPORARY = tmp__38;
      tmp___9 = (tmp__38 ^ tmp__39) + tmp__39;
      _2e_lcssa__PHI_TEMPORARY = ((unsigned int )tmp___9 == 2U) & 1;
      goto block_401150;
    }
    block_40114a_2e_backedge_2e_block_40113a_crit_edge: 
    _2e_pre = *tmp__22;
    tmp__29__PHI_TEMPORARY = _2e_pre;
    tmp__30__PHI_TEMPORARY = tmp__36;
    goto block_40113a;
  }
  block_401150: 
  ...
  tmp__31 = llvm_OC_ctpop_OC_i32(_2e_lcssa2 & 255);
  *tmp__9 = (_2e_lcssa3 < 39) & 1;
  tmp___11 = tmp__31 & 1;
  *tmp__11 = tmp___11 ^ 1;
  tmp___12 = (_2e_lcssa2 ^ _2e_lcssa3) >> 4;
  *tmp__12 = tmp___12 & 1;
  *tmp__13 = 0;
  *tmp__15 = _2e_lcssa1;
  *tmp__17 = _2e_lcssa;
  STATE_REG_RAX = 0;
  tmp__32 = *((int *)tmp__20);
  STATE_REG_RBP = tmp__32;
  tmp___13 = tmp__20 + 8;
  tmp__33 = *((int *)tmp___13);
  STATE_REG_IP = tmp__33;
