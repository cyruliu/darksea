...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__66 ,
                                       int tmp__67 , void *tmp__68 ) ;
...
{ 
  ...
  *tmp__17 = ((unsigned int )tmp___7 == 2U) & 1;
  ...
  block_401169: 
  tmp__36 = tmp__49 + -1;
  *tmp__9 = ((unsigned int )tmp__49 == 0U) & 1;
  tmp__37 = llvm_OC_ctpop_OC_i32(tmp__36 & 255);
  tmp___9 = tmp__37 & 1;
  *tmp__11 = tmp___9 ^ 1;
  tmp___10 = (tmp__36 ^ tmp__49) >> 4;
  *tmp__12 = tmp___10 & 1;
  *tmp__13 = ((unsigned int )tmp__36 == 0U) & 1;
  tmp__38 = tmp__36 >> 31;
  tmp__39 = tmp__38;
  *tmp__15 = tmp__39;
  tmp___11 = (tmp__38 ^ tmp__54) + tmp__54;
  *tmp__17 = ((unsigned int )tmp___11 == 2U) & 1;
  tmp___12 = (tmp__38 ^ tmp__54) + tmp__54;
  if (((((unsigned int )tmp__36 == 0U) & 1) | ((((tmp__39 != 0) & 1) ^ (((unsigned int )tmp___12 == 2U) & 1)) & 1)) & 1) {
    goto block_40118c;
  }
  block_40117b_2e_preheader: 
  tmp__40 = *tmp__29;
  tmp__41 = *tmp__28;
  tmp__42 = tmp__41 + tmp__40;
  if ((tmp__42 > -1) & 1) {
    tmp__43__PHI_TEMPORARY = tmp__41;
    tmp__44__PHI_TEMPORARY = tmp__40;
    goto block_401171;
  } else {
    _2e_lcssa2__PHI_TEMPORARY = tmp__40;
    _2e_lcssa1__PHI_TEMPORARY = tmp__42;
    goto block_401187_2e_loopexit;
  }
  while (1) {
    block_401171: 
    tmp__43 = tmp__43__PHI_TEMPORARY;
    tmp__44 = tmp__44__PHI_TEMPORARY;
    *tmp__29 = llvm_sub_u32(tmp__44, tmp__43);
    tmp__45 = *tmp__28;
    tmp__46 = tmp__45 + 1;
    *tmp__28 = tmp__46;
    tmp__47 = *tmp__29;
    tmp__48 = tmp__46 + tmp__47;
    if ((tmp__48 > -1) & 1) {
      tmp__43__PHI_TEMPORARY = tmp__46;
      tmp__44__PHI_TEMPORARY = tmp__47;
      goto block_401171;
    } else {
      _2e_lcssa2__PHI_TEMPORARY = tmp__47;
      _2e_lcssa1__PHI_TEMPORARY = tmp__48;
      goto block_401187_2e_loopexit;
    }
  }
  block_401150: 
  tmp__49 = *tmp__28;
  tmp__50 = tmp__49 + 65535;
  *tmp__9 = (tmp__49 < -65535) & 1;
  tmp__51 = llvm_OC_ctpop_OC_i32(tmp__50 & 255);
  tmp___13 = tmp__51 & 1;
  *tmp__11 = tmp___13 ^ 1;
  tmp___14 = (tmp__50 ^ tmp__49) >> 4;
  *tmp__12 = tmp___14 & 1;
  *tmp__13 = ((unsigned int )tmp__50 == 0U) & 1;
  tmp__52 = tmp__50 >> 31;
  tmp__53 = tmp__52;
  *tmp__15 = tmp__53;
  tmp__54 = tmp__49 >> 31;
  tmp___15 = (tmp__52 ^ tmp__54) + (tmp__54 ^ 1);
  *tmp__17 = ((unsigned int )tmp___15 == 2U) & 1;
  tmp___16 = (tmp__52 ^ tmp__54) + (tmp__54 ^ 1);
  if ((((tmp__53 != 0) & 1) ^ (((unsigned int )tmp___16 == 2U) & 1)) & 1) {
    goto block_40118c;
  }
  block_401159: 
  tmp__55 = tmp__49 + -65535;
  *tmp__9 = (tmp__49 < 65535) & 1;
  tmp__56 = llvm_OC_ctpop_OC_i32(tmp__55 & 255);
  tmp___17 = tmp__56 & 1;
  *tmp__11 = tmp___17 ^ 1;
  tmp___18 = ((tmp__49 ^ 16) ^ tmp__55) >> 4;
  *tmp__12 = tmp___18 & 1;
  *tmp__13 = ((unsigned int )tmp__55 == 0U) & 1;
  tmp__57 = tmp__55 >> 31;
  tmp__58 = tmp__57;
  *tmp__15 = tmp__58;
  tmp___19 = (tmp__57 ^ tmp__54) + tmp__54;
  *tmp__17 = ((unsigned int )tmp___19 == 2U) & 1;
  tmp___20 = (tmp__57 ^ tmp__54) + tmp__54;
  if (((((unsigned int )tmp__55 == 0U) & 1) | ((((tmp__58 != 0) & 1) ^ (((unsigned int )tmp___20 == 2U) & 1)) & 1)) & 1) {
    goto block_401169;
  }
  block_40118c: 
  STATE_REG_RAX = 0;
  tmp__59 = *((int *)tmp__26);
  STATE_REG_RBP = tmp__59;
  tmp___21 = tmp__26 + 8;
  tmp__60 = *((int *)tmp___21);
  STATE_REG_IP = tmp__60;
  STATE_REG_RSP = tmp__26 + 16;
  return (tmp__25);
  block_401187_2e_loopexit: 
  _2e_lcssa2 = _2e_lcssa2__PHI_TEMPORARY;
  _2e_lcssa1 = _2e_lcssa1__PHI_TEMPORARY;
  STATE_REG_RDX = _2e_lcssa2;
  tmp__61 = llvm_OC_ctpop_OC_i32(_2e_lcssa1 & 255);
  *tmp__9 = 0;
  tmp___22 = tmp__61 & 1;
  *tmp__11 = tmp___22 ^ 1;
  ...
  *tmp__12 = 0;
  goto block_40118c;
  block_401140: 
  tmp__62 = tmp__30 + -65535;
  *tmp__9 = (tmp__30 < 65535) & 1;
  tmp__63 = llvm_OC_ctpop_OC_i32(tmp__62 & 255);
  tmp___23 = tmp__63 & 1;
  *tmp__11 = tmp___23 ^ 1;
  tmp___24 = ((tmp__30 ^ 16) ^ tmp__62) >> 4;
  *tmp__12 = tmp___24 & 1;
  *tmp__13 = ((unsigned int )tmp__62 == 0U) & 1;
  tmp__64 = tmp__62 >> 31;
  tmp__65 = tmp__64;
  *tmp__15 = tmp__65;
  tmp___25 = (tmp__64 ^ tmp__35) + tmp__35;
  *tmp__17 = ((unsigned int )tmp___25 == 2U) & 1;
  tmp___26 = (tmp__64 ^ tmp__35) + tmp__35;
  if (((((unsigned int )tmp__62 == 0U) & 1) | ((((tmp__65 != 0) & 1) ^ (((unsigned int )tmp___26 == 2U) & 1)) & 1)) & 1) {
    goto block_401150;
  } else {
    goto block_40118c;
  }
...
{ 
  ...
  {
  tmp__69 = STATE_REG_RBP;
  tmp__70 = STATE_REG_RSP;
  tmp = tmp__70 + -8;
  *((int *)tmp) = tmp__69;
  STATE_REG_RBP = tmp__69;
  tmp__71 = *((int *)tmp__70);
  STATE_REG_IP = tmp__71;
  STATE_REG_RSP = tmp__70 + 8;
  return (tmp__68);
}
}
