...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__79 ,
                                       int tmp__80 , void *tmp__81 ) ;
...
{ 
  ...
  *tmp__29 = tmp__27;
  tmp___4 = tmp__26 + -4;
  tmp__30 = *((int *)tmp___4);
  tmp__31 = tmp__30 + 1073741823;
  *tmp__9 = (tmp__30 < -1073741823) & 1;
  ...
  *tmp__17 = ((unsigned int )tmp___7 == 2U) & 1;
  ...
  if ((((tmp__34 != 0) & 1) ^ (((unsigned int )tmp___8 == 2U) & 1)) & 1) {
    tmp__36__PHI_TEMPORARY = tmp__26;
    goto block_401196;
  } else {
    goto block_401140;
  }
  ...
  STATE_REG_RSP = tmp__36 + 16;
  return (tmp__25);
  block_401191: 
  _2e_lcssa3 = _2e_lcssa3__PHI_TEMPORARY;
  tmp__39 = llvm_OC_ctpop_OC_i32(_2e_lcssa3 & 255);
  *tmp__9 = 0;
  tmp___10 = tmp__39 & 1;
  *tmp__11 = tmp___10 ^ 1;
  *tmp__12 = 0;
  *tmp__13 = ((unsigned int )_2e_lcssa3 == 0U) & 1;
  *tmp__15 = 1;
  *tmp__17 = 0;
  tmp__36__PHI_TEMPORARY = tmp__48;
  goto block_401196;
  block_401150: 
  tmp__40 = *tmp__29;
  tmp__41 = tmp__40 + -1073741823;
  *tmp__9 = (tmp__40 < 1073741823) & 1;
  tmp__42 = llvm_OC_ctpop_OC_i32(tmp__41 & 255);
  tmp___11 = tmp__42 & 1;
  *tmp__11 = tmp___11 ^ 1;
  tmp___12 = ((tmp__40 ^ 16) ^ tmp__41) >> 4;
  *tmp__12 = tmp___12 & 1;
  ...
  *tmp__15 = tmp__44;
  tmp__45 = tmp__40 >> 31;
  tmp___13 = (tmp__43 ^ tmp__45) + tmp__45;
  *tmp__17 = ((unsigned int )tmp___13 == 2U) & 1;
  tmp___14 = (tmp__43 ^ tmp__45) + tmp__45;
  if (! (((((unsigned int )tmp__41 == 0U) & 1) | ((((tmp__44 != 0) & 1) ^ (((unsigned int )tmp___14 == 2U) & 1)) & 1)) & 1)) {
    tmp__36__PHI_TEMPORARY = tmp__26;
    goto block_401196;
  }
  block_40118b_2e_outer_2e_preheader: 
  tmp__46 = tmp__28 + 87;
  tmp__47__PHI_TEMPORARY = tmp__46;
  tmp__48__PHI_TEMPORARY = tmp__26;
  ...
  while (1) {
    ...
    tmp___15 = tmp__48 + -8;
    tmp__49 = (int *)tmp___15;
    tmp__50 = *tmp__49;
    if (! ((tmp__50 > -1) & 1)) {
      _2e_lcssa3__PHI_TEMPORARY = tmp__50;
      goto block_401191;
    }
    block_401160_2e_lr_2e_ph: 
    tmp___16 = tmp__48 + -4;
    tmp__51 = (int *)tmp___16;
    tmp__69__PHI_TEMPORARY = tmp__47;
    goto block_401160;
    while (1) {
      block_401160: 
      ...
      *tmp__51 = tmp__71;
      tmp__72 = tmp__71 >> 31;
      tmp__73 = tmp__72;
      tmp___17 = llvm_select_u64((tmp__73 == 0) & 1, 2, 31);
      tmp___18 = tmp__69 + -35;
      tmp__74 = tmp___18 + tmp___17;
      if (! ((tmp__73 == 1) & 1)) {
        goto block_40116a;
      }
      block_401187: 
      ...
      *tmp__49 = tmp__68;
      if ((tmp__68 > -1) & 1) {
        tmp__69__PHI_TEMPORARY = tmp__66;
        goto block_401160;
      } else {
        _2e_lcssa3__PHI_TEMPORARY = tmp__68;
        goto block_401191;
      }
    }
    block_40116a: 
    tmp__52 = llvm_OC_ctpop_OC_i32(tmp__71 & 255);
    *tmp__9 = 0;
    tmp___19 = tmp__52 & 1;
    *tmp__11 = tmp___19 ^ 1;
    *tmp__12 = 0;
    *tmp__13 = ((unsigned int )tmp__71 == 0U) & 1;
    *tmp__15 = tmp__72;
    *tmp__17 = 0;
    STATE_REG_RAX = 0;
    tmp__53 = STATE_REG_RSP;
    tmp__54 = tmp__53 + -8;
    *((int *)tmp__54) = tmp__74 + 10;
    STATE_REG_RSP = tmp__54;
    STATE_REG_RAX = __VERIFIER_nondet_int();
    tmp__56 = STATE_REG_RBP;
    tmp__57 = STATE_REG_RAX;
    tmp__58 = STATE_REG_IP;
    tmp___20 = tmp__56 + -8;
    *((int *)tmp___20) = tmp__57;
    tmp__59 = tmp__57 + -1073741823;
    *tmp__9 = (tmp__57 < 1073741823) & 1;
    tmp__60 = llvm_OC_ctpop_OC_i32(tmp__59 & 255);
    tmp___21 = tmp__60 & 1;
    *tmp__11 = tmp___21 ^ 1;
    tmp___22 = ((tmp__57 ^ 16) ^ tmp__59) >> 4;
    *tmp__12 = tmp___22 & 1;
    ...
    *tmp__15 = tmp__62;
    tmp__63 = tmp__57 >> 31;
    tmp___23 = (tmp__61 ^ tmp__63) + tmp__63;
    *tmp__17 = ((unsigned int )tmp___23 == 2U) & 1;
    tmp___24 = (tmp__61 ^ tmp__63) + tmp__63;
    tmp__64 = ((((unsigned int )tmp__59 == 0U) & 1) | ((((tmp__62 != 0) & 1) ^ (((unsigned int )tmp___24 == 2U) & 1)) & 1)) & 1;
    tmp___25 = llvm_select_u64(tmp__64, 13, 2);
    tmp___26 = tmp__58 + 10;
    tmp__65 = tmp___26 + tmp___25;
    if (tmp__64) {
      tmp__47__PHI_TEMPORARY = tmp__65;
      tmp__48__PHI_TEMPORARY = tmp__56;
      goto block_40118b_2e_outer;
    } else {
      tmp__36__PHI_TEMPORARY = tmp__56;
      goto block_401196;
    }
  }
  block_401140: 
  tmp__75 = tmp__30 + -1073741823;
  *tmp__9 = (tmp__30 < 1073741823) & 1;
  tmp__76 = llvm_OC_ctpop_OC_i32(tmp__75 & 255);
  tmp___27 = tmp__76 & 1;
  *tmp__11 = tmp___27 ^ 1;
  tmp___28 = ((tmp__30 ^ 16) ^ tmp__75) >> 4;
  *tmp__12 = tmp___28 & 1;
  *tmp__13 = ((unsigned int )tmp__75 == 0U) & 1;
  tmp__77 = tmp__75 >> 31;
  tmp__78 = tmp__77;
  *tmp__15 = tmp__78;
  tmp___29 = (tmp__77 ^ tmp__35) + tmp__35;
  *tmp__17 = ((unsigned int )tmp___29 == 2U) & 1;
  tmp___30 = (tmp__77 ^ tmp__35) + tmp__35;
  if (((((unsigned int )tmp__75 == 0U) & 1) | ((((tmp__78 != 0) & 1) ^ (((unsigned int )tmp___30 == 2U) & 1)) & 1)) & 1) {
    goto block_401150;
  } else {
    tmp__36__PHI_TEMPORARY = tmp__26;
    goto block_401196;
...
{ 
  ...
  {
  tmp__82 = STATE_REG_RBP;
  tmp__83 = STATE_REG_RSP;
  tmp = tmp__83 + -8;
  *((int *)tmp) = tmp__82;
  STATE_REG_RBP = tmp__82;
  tmp__84 = *((int *)tmp__83);
  STATE_REG_IP = tmp__84;
  STATE_REG_RSP = tmp__83 + 8;
  return (tmp__81);
}
}
