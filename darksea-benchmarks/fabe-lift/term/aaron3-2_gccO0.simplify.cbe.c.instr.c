...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__84 ,
                                       int tmp__85 , void *tmp__86 ) ;
...
{ 
  ...
  *((int *)tmp___5) = tmp__39;
  tmp__41 = tmp__40 + 48;
  tmp__42__PHI_TEMPORARY = tmp__41;
  tmp__43__PHI_TEMPORARY = tmp__38;
  goto block_40117e;
  while (1) {
    block_40117e: 
    ...
    *tmp__9 = (tmp__44 < tmp__45) & 1;
    ...
    tmp___8 = tmp__47 & 1;
    *tmp__11 = tmp___8 ^ 1;
    tmp___9 = ((tmp__45 ^ tmp__44) ^ tmp__46) >> 4;
    *tmp__12 = tmp___9 & 1;
    ...
    *tmp__15 = tmp__49;
    tmp__50 = tmp__44 >> 31;
    tmp___10 = tmp__45 >> 31;
    tmp___11 = (tmp__48 ^ tmp__50) + (tmp___10 ^ tmp__50);
    *tmp__17 = ((unsigned int )tmp___11 == 2U) & 1;
    tmp___12 = tmp__45 >> 31;
    tmp___13 = (tmp__48 ^ tmp__50) + (tmp___12 ^ tmp__50);
    if ((((tmp__49 != 0) & 1) ^ (((unsigned int )tmp___13 == 2U) & 1)) & 1) {
      goto block_401193;
    }
    block_401186: 
    tmp___14 = tmp__43 + -16;
    tmp__63 = *((int *)tmp___14);
    STATE_REG_RDX = tmp__63;
    tmp___15 = tmp__43 + -12;
    tmp__64 = *((int *)tmp___15);
    tmp__65 = tmp__64 + tmp__63;
    tmp__66 = llvm_sub_u32(tmp__44, tmp__65);
    *tmp__9 = (tmp__44 < tmp__65) & 1;
    tmp__67 = llvm_OC_ctpop_OC_i32(tmp__66 & 255);
    tmp___16 = tmp__67 & 1;
    *tmp__11 = tmp___16 ^ 1;
    tmp___17 = ((tmp__65 ^ tmp__44) ^ tmp__66) >> 4;
    *tmp__12 = tmp___17 & 1;
    *tmp__13 = ((unsigned int )tmp__66 == 0U) & 1;
    tmp__68 = tmp__66 >> 31;
    tmp__69 = tmp__68;
    *tmp__15 = tmp__69;
    tmp___18 = tmp__65 >> 31;
    tmp___19 = (tmp__68 ^ tmp__50) + (tmp___18 ^ tmp__50);
    *tmp__17 = ((unsigned int )tmp___19 == 2U) & 1;
    tmp___20 = tmp__65 >> 31;
    tmp___21 = (tmp__68 ^ tmp__50) + (tmp___20 ^ tmp__50);
    if (! (((((unsigned int )tmp__66 == 0U) & 1) | ((((tmp__69 != 0) & 1) ^ (((unsigned int )tmp___21 == 2U) & 1)) & 1)) & 1)) {
      goto block_401193;
    }
    block_401153: 
    STATE_REG_RAX = 0;
    tmp__54 = STATE_REG_RSP;
    tmp__55 = tmp__54 + -8;
    *((int *)tmp__55) = tmp__42 + -33;
    STATE_REG_RSP = tmp__55;
    STATE_REG_RAX = __VERIFIER_nondet_int();
    tmp__57 = STATE_REG_RAX;
    tmp__58 = STATE_REG_IP;
    tmp___22 = llvm_select_u64(((unsigned int )tmp__57 == 0U) & 1, 27, 2);
    tmp___23 = tmp__58 + 2;
    tmp__59 = tmp___23 + tmp___22;
    tmp__60 = STATE_REG_RBP;
    if (((unsigned int )tmp__57 == 0U) & 1) {
      goto block_40117a;
    }
    block_401161: 
    tmp___24 = tmp__60 + -12;
    tmp__70 = (int *)tmp___24;
    tmp__71 = *tmp__70;
    tmp__72 = tmp__71 + -1;
    *tmp__70 = tmp__72;
    *tmp__9 = ((unsigned int )tmp__71 == 0U) & 1;
    tmp__73 = llvm_OC_ctpop_OC_i32(tmp__72 & 255);
    tmp___25 = tmp__73 & 1;
    *tmp__11 = tmp___25 ^ 1;
    tmp___26 = (tmp__72 ^ tmp__71) >> 4;
    *tmp__12 = tmp___26 & 1;
    *tmp__13 = ((unsigned int )tmp__72 == 0U) & 1;
    tmp__74 = tmp__72 >> 31;
    *tmp__15 = tmp__74;
    tmp__75 = tmp__71 >> 31;
    tmp___27 = (tmp__74 ^ tmp__75) + tmp__75;
    *tmp__17 = ((unsigned int )tmp___27 == 2U) & 1;
    tmp___28 = tmp__60 + -4;
    tmp__76 = *((int *)tmp___28);
    tmp___29 = tmp__60 + -16;
    *((int *)tmp___29) = tmp__76;
    STATE_REG_RAX = 0;
    tmp__77 = STATE_REG_RSP;
    tmp__78 = tmp__77 + -8;
    *((int *)tmp__78) = tmp__59 + 20;
    STATE_REG_RSP = tmp__78;
    STATE_REG_RAX = __VERIFIER_nondet_int();
    tmp__80 = STATE_REG_RBP;
    tmp__81 = STATE_REG_RAX;
    tmp__82 = STATE_REG_IP;
    tmp___30 = tmp__80 + -4;
    *((int *)tmp___30) = tmp__81;
    tmp__83 = tmp__82 + 9;
    _2e_be__PHI_TEMPORARY = tmp__83;
    _2e_be3__PHI_TEMPORARY = tmp__80;
    goto block_40117e_2e_backedge;
    block_40117a: 
    tmp__51 = tmp__59 + 4;
    tmp___31 = tmp__60 + -8;
    tmp__52 = (int *)tmp___31;
    tmp__53 = *tmp__52;
    *tmp__52 = tmp__53 + 1;
    _2e_be__PHI_TEMPORARY = tmp__51;
    _2e_be3__PHI_TEMPORARY = tmp__60;
    goto block_40117e_2e_backedge;
    block_40117e_2e_backedge: 
    _2e_be = _2e_be__PHI_TEMPORARY;
    _2e_be3 = _2e_be3__PHI_TEMPORARY;
    tmp__42__PHI_TEMPORARY = _2e_be;
    tmp__43__PHI_TEMPORARY = _2e_be3;
    goto block_40117e;
  }
  block_401193: 
  STATE_REG_RAX = 0;
  tmp__61 = *((int *)tmp__43);
  STATE_REG_RBP = tmp__61;
  tmp___32 = tmp__43 + 8;
  tmp__62 = *((int *)tmp___32);
  STATE_REG_IP = tmp__62;
  STATE_REG_RSP = tmp__43 + 16;
  return (tmp__37);
}
}
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__84 ,
...
{ 
  ...
  {
  tmp__87 = STATE_REG_RBP;
  tmp__88 = STATE_REG_RSP;
  tmp = tmp__88 + -8;
  *((int *)tmp) = tmp__87;
  STATE_REG_RBP = tmp__87;
  tmp__89 = *((int *)tmp__88);
  STATE_REG_IP = tmp__89;
  STATE_REG_RSP = tmp__88 + 8;
  return (tmp__86);
}
}
