...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__86 ,
                                       int tmp__87 , void *tmp__88 ) ;
...
{ 
  ...
  {
  tmp__89 = STATE_REG_RBP;
  tmp__90 = STATE_REG_RSP;
  tmp = tmp__90 + -8;
  *((int *)tmp) = tmp__89;
  STATE_REG_RBP = tmp__89;
  tmp__91 = *((int *)tmp__90);
  STATE_REG_IP = tmp__91;
  STATE_REG_RSP = tmp__90 + 8;
  return (tmp__88);
}
}
