...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__40 ,
                                       int tmp__41 , void *tmp__42 ) ;
...
{ 
  ...
  *tmp__22 = tmp__21;
  ...
  tmp__26 = tmp__25 >> 31;
  tmp__27 = tmp__24 >> 31;
  tmp___7 = (tmp__26 ^ tmp__27) + tmp__27;
  if (! (((((unsigned int )tmp__25 == 0U) & 1) | (((((unsigned int )tmp__26 != 0U) & 1) ^ (((unsigned int )tmp___7 == 2U) & 1)) & 1)) & 1)) {
    _2e_lcssa3__PHI_TEMPORARY = tmp__24;
    _2e_lcssa2__PHI_TEMPORARY = tmp__25;
    _2e_lcssa1__PHI_TEMPORARY = tmp__26;
    tmp___6 = (tmp__26 ^ tmp__27) + tmp__27;
    _2e_lcssa__PHI_TEMPORARY = ((unsigned int )tmp___6 == 2U) & 1;
    goto block_401150;
  }
  block_40113a_2e_preheader: 
  tmp___8 = llvm_select_u32(((unsigned int )tmp__21 == 0U) & 1, 1, 2);
  tmp__28 = tmp___8 + tmp__24;
  *tmp__23 = tmp__28;
  tmp__29 = tmp__28 + -39;
  tmp__30 = tmp__29 >> 31;
  tmp__31 = tmp__28 >> 31;
  tmp___10 = (tmp__30 ^ tmp__31) + tmp__31;
  if (((((unsigned int )tmp__29 == 0U) & 1) | (((((unsigned int )tmp__30 != 0U) & 1) ^ (((unsigned int )tmp___10 == 2U) & 1)) & 1)) & 1) {
    tmp__32__PHI_TEMPORARY = tmp__28;
    goto block_40113a_2e_block_40113a_crit_edge;
  } else {
    _2e_lcssa3__PHI_TEMPORARY = tmp__28;
    _2e_lcssa2__PHI_TEMPORARY = tmp__29;
    _2e_lcssa1__PHI_TEMPORARY = tmp__30;
    tmp___9 = (tmp__30 ^ tmp__31) + tmp__31;
    _2e_lcssa__PHI_TEMPORARY = ((unsigned int )tmp___9 == 2U) & 1;
    goto block_401150;
  }
  while (1) {
    block_40113a_2e_block_40113a_crit_edge: 
    tmp__32 = tmp__32__PHI_TEMPORARY;
    _2e_pre = *tmp__22;
    tmp___11 = llvm_select_u32(((unsigned int )_2e_pre == 0U) & 1, 1, 2);
    tmp__33 = tmp___11 + tmp__32;
    *tmp__23 = tmp__33;
    tmp__34 = tmp__33 + -39;
    tmp__35 = tmp__34 >> 31;
    tmp__36 = tmp__33 >> 31;
    tmp___13 = (tmp__35 ^ tmp__36) + tmp__36;
    if (((((unsigned int )tmp__34 == 0U) & 1) | (((((unsigned int )tmp__35 != 0U) & 1) ^ (((unsigned int )tmp___13 == 2U) & 1)) & 1)) & 1) {
      tmp__32__PHI_TEMPORARY = tmp__33;
      goto block_40113a_2e_block_40113a_crit_edge;
    } else {
      _2e_lcssa3__PHI_TEMPORARY = tmp__33;
      _2e_lcssa2__PHI_TEMPORARY = tmp__34;
      _2e_lcssa1__PHI_TEMPORARY = tmp__35;
      tmp___12 = (tmp__35 ^ tmp__36) + tmp__36;
      _2e_lcssa__PHI_TEMPORARY = ((unsigned int )tmp___12 == 2U) & 1;
      goto block_401150;
    }
  }
  block_401150: 
  ...
  _2e_lcssa = _2e_lcssa__PHI_TEMPORARY & 1;
  tmp__37 = llvm_OC_ctpop_OC_i32(_2e_lcssa2 & 255);
  *tmp__9 = (_2e_lcssa3 < 39) & 1;
  tmp___14 = tmp__37 & 1;
  *tmp__11 = tmp___14 ^ 1;
  tmp___15 = (_2e_lcssa2 ^ _2e_lcssa3) >> 4;
  *tmp__12 = tmp___15 & 1;
  *tmp__13 = 0;
  *tmp__15 = _2e_lcssa1;
  *tmp__17 = _2e_lcssa;
  STATE_REG_RAX = 0;
  tmp__38 = *((int *)tmp__20);
  STATE_REG_RBP = tmp__38;
  tmp___16 = tmp__20 + 8;
  tmp__39 = *((int *)tmp___16);
  STATE_REG_IP = tmp__39;
  STATE_REG_RSP = tmp__20 + 16;
  return (tmp__19);
}
}
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__40 ,
...
{ 
  ...
  {
  tmp__43 = STATE_REG_RBP;
  tmp__44 = STATE_REG_RSP;
  tmp = tmp__44 + -8;
  *((int *)tmp) = tmp__43;
  STATE_REG_RBP = tmp__43;
  tmp__45 = *((int *)tmp__44);
  STATE_REG_IP = tmp__45;
  STATE_REG_RSP = tmp__44 + 8;
  return (tmp__42);
}
}
