...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__68 ,
                                       int tmp__69 , void *tmp__70 ) ;
...
{ 
  ...
  {
  tmp__71 = STATE_REG_RBP;
  tmp__72 = STATE_REG_RSP;
  tmp = tmp__72 + -8;
  *((int *)tmp) = tmp__71;
  STATE_REG_RBP = tmp__71;
  tmp__73 = *((int *)tmp__72);
  STATE_REG_IP = tmp__73;
  STATE_REG_RSP = tmp__72 + 8;
  return (tmp__70);
}
}
