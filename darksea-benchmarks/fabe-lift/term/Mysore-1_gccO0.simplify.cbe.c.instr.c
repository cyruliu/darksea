...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__47 ,
                                       int tmp__48 , void *tmp__49 ) ;
...
{ 
  ...
  *tmp__28 = tmp__27;
  tmp__29 = tmp__27 + -1;
  *tmp__9 = ((unsigned int )tmp__27 == 0U) & 1;
  tmp__30 = llvm_OC_ctpop_OC_i32(tmp__29 & 255);
  tmp___4 = tmp__30 & 1;
  *tmp__11 = tmp___4 ^ 1;
  tmp___5 = (tmp__29 ^ tmp__27) >> 4;
  *tmp__12 = tmp___5 & 1;
  *tmp__13 = ((unsigned int )tmp__29 == 0U) & 1;
  tmp__31 = tmp__29 >> 31;
  tmp__32 = tmp__31;
  *tmp__15 = tmp__32;
  tmp__33 = tmp__27 >> 31;
  tmp___6 = (tmp__31 ^ tmp__33) + tmp__33;
  *tmp__17 = ((unsigned int )tmp___6 == 2U) & 1;
  tmp___7 = (tmp__31 ^ tmp__33) + tmp__33;
  if (((((unsigned int )tmp__29 == 0U) & 1) | ((((tmp__32 != 0) & 1) ^ (((unsigned int )tmp___7 == 2U) & 1)) & 1)) & 1) {
    goto block_401155;
  } else {
    goto block_40113d;
  }
  while (1) {
    ...
    *tmp__40 = llvm_sub_u32(tmp__35, tmp__34);
    tmp__36 = *tmp__28;
    tmp__37 = tmp__36 + 1;
    *tmp__28 = tmp__37;
    tmp__38 = *tmp__40;
    tmp__39 = tmp__37 + tmp__38;
    if ((tmp__39 > -1) & 1) {
      tmp__34__PHI_TEMPORARY = tmp__37;
      tmp__35__PHI_TEMPORARY = tmp__38;
      goto block_40113f;
    } else {
      _2e_lcssa2__PHI_TEMPORARY = tmp__38;
      _2e_lcssa1__PHI_TEMPORARY = tmp__39;
  ...
  tmp__41 = *tmp__40;
  tmp__42 = *tmp__28;
  tmp__43 = tmp__42 + tmp__41;
  if ((tmp__43 > -1) & 1) {
    tmp__34__PHI_TEMPORARY = tmp__42;
    tmp__35__PHI_TEMPORARY = tmp__41;
    goto block_40113f;
  } else {
    _2e_lcssa2__PHI_TEMPORARY = tmp__41;
    _2e_lcssa1__PHI_TEMPORARY = tmp__43;
    goto block_401155_2e_loopexit;
  }
  ...
  tmp__44 = llvm_OC_ctpop_OC_i32(_2e_lcssa1 & 255);
  *tmp__9 = 0;
  tmp___9 = tmp__44 & 1;
  *tmp__11 = tmp___9 ^ 1;
  ...
  *tmp__12 = 0;
  ...
  STATE_REG_RAX = 0;
  tmp__45 = *((int *)tmp__26);
  STATE_REG_RBP = tmp__45;
  tmp___10 = tmp__26 + 8;
  tmp__46 = *((int *)tmp___10);
  STATE_REG_IP = tmp__46;
...
{ 
  ...
  tmp = tmp__51 + -8;
  *((int *)tmp) = tmp__50;
  STATE_REG_RBP = tmp__50;
  tmp__52 = *((int *)tmp__51);
  STATE_REG_IP = tmp__52;
  STATE_REG_RSP = tmp__51 + 8;
  return (tmp__49);
}
}
