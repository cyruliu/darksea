...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__37 ,
                                       int tmp__38 , void *tmp__39 ) ;
...
{ 
  ...
  *((int *)tmp__18) = tmp__2 + 36;
  ...
  tmp__22 = (int *)tmp___4;
  *tmp__22 = tmp__21;
  tmp__23 = ((unsigned int )tmp__21 == 0U) & 1;
  tmp___5 = tmp__21 >> 31;
  tmp__24 = tmp___5;
  tmp___6 = tmp__23 | tmp__24;
  if (! ((tmp___6 == 0) & 1)) {
    _2e_lcssa2__PHI_TEMPORARY = tmp__21;
    _2e_lcssa1__PHI_TEMPORARY = tmp__23;
    _2e_lcssa__PHI_TEMPORARY = tmp__24;
    goto block_40114c;
  }
  ...
  tmp__26 = (int *)tmp___8;
  goto block_40113a;
  block_40114c_2e_loopexit: 
  tmp__27 = ((unsigned int )tmp__35 == 0U) & 1;
  tmp__28 = tmp__36;
  _2e_lcssa2__PHI_TEMPORARY = tmp__35;
  _2e_lcssa1__PHI_TEMPORARY = tmp__27;
  _2e_lcssa__PHI_TEMPORARY = tmp__28;
  goto block_40114c;
  block_40114c: 
  _2e_lcssa2 = _2e_lcssa2__PHI_TEMPORARY;
  _2e_lcssa1 = _2e_lcssa1__PHI_TEMPORARY;
  _2e_lcssa = _2e_lcssa__PHI_TEMPORARY;
  tmp__29 = llvm_OC_ctpop_OC_i32(_2e_lcssa2 & 255);
  *tmp__9 = 0;
  tmp___9 = tmp__29 & 1;
  *tmp__11 = tmp___9 ^ 1;
  *tmp__12 = 0;
  ...
  *tmp__17 = 0;
  STATE_REG_RAX = 0;
  tmp__30 = *((int *)tmp__20);
  STATE_REG_RBP = tmp__30;
  tmp___10 = tmp__20 + 8;
  tmp__31 = *((int *)tmp___10);
  STATE_REG_IP = tmp__31;
  ...
  while (1) {
    ...
    *tmp__22 = tmp__35;
    tmp__36 = tmp__35 >> 31;
    tmp___11 = (((unsigned int )tmp__35 == 0U) & 1) | tmp__36;
    if ((tmp___11 == 0) & 1) {
      goto block_40113a;
    } else {
      goto block_40114c_2e_loopexit;
    }
  }
}
}
...
{ 
  ...
  {
  tmp__40 = STATE_REG_RBP;
  tmp__41 = STATE_REG_RSP;
  tmp = tmp__41 + -8;
  *((int *)tmp) = tmp__40;
  STATE_REG_RBP = tmp__40;
  tmp__42 = *((int *)tmp__41);
  STATE_REG_IP = tmp__42;
  STATE_REG_RSP = tmp__41 + 8;
  return (tmp__39);
}
}
