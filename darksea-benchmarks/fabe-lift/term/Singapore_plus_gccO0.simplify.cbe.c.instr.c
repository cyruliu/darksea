...
void *sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State *tmp__49 ,
                                       int tmp__50 , void *tmp__51 ) ;
...
{ 
  ...
  *tmp__28 = tmp__27;
  ...
  tmp__31 = *tmp__28;
  tmp__32 = tmp__31 + tmp__30;
  *tmp__9 = 0;
  tmp__33 = llvm_OC_ctpop_OC_i32(tmp__32 & 255);
  tmp___5 = tmp__33 & 1;
  *tmp__11 = tmp___5 ^ 1;
  *tmp__13 = ((unsigned int )tmp__32 == 0U) & 1;
  tmp___6 = tmp__32 >> 31;
  tmp__34 = tmp___6;
  *tmp__15 = tmp__34;
  *tmp__17 = 0;
  *tmp__12 = 0;
  ...
  block_401157_2e_preheader: 
  tmp__35 = *tmp__29;
  tmp__36 = ((unsigned int )tmp__35 == 0U) & 1;
  tmp___7 = tmp__35 >> 31;
  tmp__37 = tmp___7;
  tmp___8 = tmp__36 | tmp__37;
  if ((tmp___8 == 0) & 1) {
    tmp__38__PHI_TEMPORARY = tmp__35;
    goto block_401145;
  } else {
    _2e_lcssa2__PHI_TEMPORARY = tmp__35;
    _2e_lcssa1__PHI_TEMPORARY = tmp__36;
    _2e_lcssa__PHI_TEMPORARY = tmp__37;
    goto block_40115d_2e_loopexit;
  }
  while (1) {
    block_401145: 
    tmp__38 = tmp__38__PHI_TEMPORARY;
    tmp__39 = tmp__38 << 1UL;
    STATE_REG_RDX = (int )((unsigned long )tmp__39 & 4294967294UL);
    tmp__40 = *tmp__28;
    *tmp__29 = tmp__40 + tmp__39;
    tmp__41 = *tmp__28;
    *tmp__28 = tmp__41 + 1;
    tmp__42 = *tmp__29;
    tmp__43 = tmp__42 >> 31;
    tmp___9 = (((unsigned int )tmp__42 == 0U) & 1) | tmp__43;
    if ((tmp___9 == 0) & 1) {
      tmp__38__PHI_TEMPORARY = tmp__42;
      goto block_401145;
    } else {
      goto block_40115d_2e_loopexit_2e_loopexit;
    }
  }
  block_40115d_2e_loopexit_2e_loopexit: 
  tmp__44 = ((unsigned int )tmp__42 == 0U) & 1;
  tmp__45 = tmp__43;
  _2e_lcssa2__PHI_TEMPORARY = tmp__42;
  _2e_lcssa1__PHI_TEMPORARY = tmp__44;
  _2e_lcssa__PHI_TEMPORARY = tmp__45;
  goto block_40115d_2e_loopexit;
  ...
  tmp__46 = llvm_OC_ctpop_OC_i32(_2e_lcssa2 & 255);
  *tmp__9 = 0;
  tmp___10 = tmp__46 & 1;
  *tmp__11 = tmp___10 ^ 1;
  *tmp__12 = 0;
  ...
  *tmp__17 = 0;
  ...
  STATE_REG_RAX = 0;
  tmp__47 = *((int *)tmp__26);
  STATE_REG_RBP = tmp__47;
  tmp___11 = tmp__26 + 8;
  tmp__48 = *((int *)tmp___11);
  STATE_REG_IP = tmp__48;
