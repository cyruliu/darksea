...
{ 
  ...
  *tmp__28 = tmp__27;
  ...
  goto block_401149;
  block_401155: 
  tmp__31 = llvm_OC_ctpop_OC_i32(tmp__34 & 255);
  *tmp__9 = 0;
  tmp___5 = tmp__31 & 1;
  *tmp__11 = tmp___5 ^ 1;
  *tmp__12 = 0;
  *tmp__13 = ((unsigned int )tmp__34 == 0U) & 1;
  *tmp__15 = tmp__35;
  *tmp__17 = 0;
  STATE_REG_RAX = 0;
  tmp__32 = *((int *)tmp__26);
  ...
  while (1) {
    ...
    tmp__36 = *tmp__29;
    if ((tmp__36 > -1) & 1) {
      _2e_pre_2d_phi__PHI_TEMPORARY = tmp__29;
    ...
    tmp__34 = *tmp__28;
    tmp__35 = tmp__34 >> 31;
    if (((unsigned int )tmp__35 == 0U) & 1) {
      _2e_pre_2d_phi__PHI_TEMPORARY = tmp__28;
      tmp__30__PHI_TEMPORARY = tmp__34;
      goto block_401149_2e_backedge;
    } else {
      goto block_401155;
    }
