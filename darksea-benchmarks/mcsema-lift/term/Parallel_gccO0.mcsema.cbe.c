...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__44, int tmp__45, void* tmp__46) {
  int* tmp__47;
  int tmp__48;
  int* tmp__49;
  int tmp__50;
  ...
  tmp__47 = (&tmp__44->field6.field15.field0.field0);
  tmp__48 = *tmp__47;
  tmp__49 = (&tmp__44->field6.field13.field0.field0);
  tmp__50 = *tmp__49;
  tmp__51 = llvm_add_u64(tmp__50, (18446744073709551608UL));
  *(((int*)tmp__51)) = tmp__48;
  tmp__52 = *(((int*)tmp__51));
  *tmp__47 = tmp__52;
  tmp__53 = *(((int*)tmp__50));
  *((&tmp__44->field6.field33.field0.field0)) = tmp__53;
  *tmp__49 = (llvm_add_u64(tmp__50, (8UL)));
  return tmp__46;
}
