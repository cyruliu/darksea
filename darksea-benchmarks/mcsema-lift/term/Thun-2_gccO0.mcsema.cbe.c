...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__76, int tmp__77, void* tmp__78) {
  int* tmp__79;
  int tmp__80;
  int* tmp__81;
  int tmp__82;
  ...
  tmp__79 = (&tmp__76->field6.field15.field0.field0);
  tmp__80 = *tmp__79;
  tmp__81 = (&tmp__76->field6.field13.field0.field0);
  tmp__82 = *tmp__81;
  tmp__83 = llvm_add_u64(tmp__82, (18446744073709551608UL));
  *(((int*)tmp__83)) = tmp__80;
  tmp__84 = *(((int*)tmp__83));
  *tmp__79 = tmp__84;
  tmp__85 = *(((int*)tmp__82));
  *((&tmp__76->field6.field33.field0.field0)) = tmp__85;
  *tmp__81 = (llvm_add_u64(tmp__82, (8UL)));
  return tmp__78;
}
