...
static  int llvm_select_u32(int condition, int iftrue, int ifnot) {
  int r;
...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, int tmp__2, void* tmp__3) {
  ...
  *(((int*)tmp__25)) = tmp__26;
  ...
  tmp__32__PHI_TEMPORARY = tmp__23;   /* for PHI node */
  goto block_40114a;

block_401150:
  tmp__29 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__34 & 255));
  *tmp__13 = (((int)(int)(((((int)tmp__33) < ((int)39u))&1))));
  *tmp__15 = (llvm_xor_u8((llvm_and_u8((((int)tmp__29)), 1)), 1));
  *tmp__16 = (llvm_and_u8((((int)(llvm_lshr_u32((tmp__34 ^ tmp__33), 4)))), 1));
  *tmp__17 = 0;
  *tmp__19 = (((int)tmp__35));
  *tmp__21 = (((int)(int)((((llvm_add_u32((tmp__35 ^ tmp__36), tmp__36)) == 2u)&1))));
  *tmp__5 = (0UL);
  tmp__30 = *(((int*)tmp__24));
  *tmp__7 = tmp__30;
  tmp__31 = *(((int*)(llvm_add_u64(tmp__24, (8UL)))));
  *tmp__8 = tmp__31;
...
block_40114a:
  ...
  tmp__33 = *(((int*)tmp__27));
  tmp__34 = llvm_add_u32(tmp__33, -39);
  tmp__35 = llvm_lshr_u32(tmp__34, 31);
  tmp__36 = llvm_lshr_u32(tmp__33, 31);
  if (((((((tmp__34 == 0u)&1)) | ((((((tmp__35 != 0u)&1)) ^ ((((llvm_add_u32((tmp__35 ^ tmp__36), tmp__36)) == 2u)&1)))&1)))&1))) {
    goto block_40113a;
  } else {
    goto block_401150;
  }
...
block_40113a:
  tmp__28 = *(((int*)tmp__25));
  *(((int*)tmp__27)) = (llvm_add_u32(tmp__33, (llvm_select_u32((((tmp__28 == 0u)&1)), 1, 2))));
  tmp__32__PHI_TEMPORARY = tmp__32;   /* for PHI node */
  goto block_40114a;
...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__37, int tmp__38, void* tmp__39) {
  int* tmp__40;
  int tmp__41;
  int* tmp__42;
  int tmp__43;
  ...
  tmp__40 = (&tmp__37->field6.field15.field0.field0);
  tmp__41 = *tmp__40;
  tmp__42 = (&tmp__37->field6.field13.field0.field0);
  tmp__43 = *tmp__42;
  tmp__44 = llvm_add_u64(tmp__43, (18446744073709551608UL));
  *(((int*)tmp__44)) = tmp__41;
  tmp__45 = *(((int*)tmp__44));
  *tmp__40 = tmp__45;
  tmp__46 = *(((int*)tmp__43));
  *((&tmp__37->field6.field33.field0.field0)) = tmp__46;
  *tmp__42 = (llvm_add_u64(tmp__43, (8UL)));
  return tmp__39;
}
