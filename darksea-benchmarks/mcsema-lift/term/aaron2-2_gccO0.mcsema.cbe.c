...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__77, int tmp__78, void* tmp__79) {
  int* tmp__80;
  int tmp__81;
  int* tmp__82;
  int tmp__83;
  ...
  tmp__80 = (&tmp__77->field6.field15.field0.field0);
  tmp__81 = *tmp__80;
  tmp__82 = (&tmp__77->field6.field13.field0.field0);
  tmp__83 = *tmp__82;
  tmp__84 = llvm_add_u64(tmp__83, (18446744073709551608UL));
  *(((int*)tmp__84)) = tmp__81;
  tmp__85 = *(((int*)tmp__84));
  *tmp__80 = tmp__85;
  tmp__86 = *(((int*)tmp__83));
  *((&tmp__77->field6.field33.field0.field0)) = tmp__86;
  *tmp__82 = (llvm_add_u64(tmp__83, (8UL)));
  return tmp__79;
}
