...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__65, int tmp__66, void* tmp__67) {
  int* tmp__68;
  int tmp__69;
  int* tmp__70;
  int tmp__71;
  ...
  tmp__68 = (&tmp__65->field6.field15.field0.field0);
  tmp__69 = *tmp__68;
  tmp__70 = (&tmp__65->field6.field13.field0.field0);
  tmp__71 = *tmp__70;
  tmp__72 = llvm_add_u64(tmp__71, (18446744073709551608UL));
  *(((int*)tmp__72)) = tmp__69;
  tmp__73 = *(((int*)tmp__72));
  *tmp__68 = tmp__73;
  tmp__74 = *(((int*)tmp__71));
  *((&tmp__65->field6.field33.field0.field0)) = tmp__74;
  *tmp__70 = (llvm_add_u64(tmp__71, (8UL)));
  return tmp__67;
}
