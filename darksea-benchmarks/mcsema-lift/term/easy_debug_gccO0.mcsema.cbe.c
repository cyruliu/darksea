...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, int tmp__2, void* tmp__3) {
  ...
  int tmp__38;
  int tmp__39;
  int tmp__39__PHI_TEMPORARY;
  int tmp__40;
  int tmp__40__PHI_TEMPORARY;
  ...
  *(((int*)(llvm_add_u64(tmp__10, (18446744073709551604UL))))) = 0;
  *(((int*)(llvm_add_u64(tmp__10, (18446744073709551600UL))))) = 100;
  *tmp__5 = (0UL);
  ...
  *(((int*)tmp__25)) = tmp__26;
  ...
  tmp__33__PHI_TEMPORARY = tmp__23;   /* for PHI node */
  goto block_40114a;

block_401150:
  tmp__30 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__35 & 255));
  *tmp__13 = (((int)(int)(((((int)tmp__34) < ((int)39u))&1))));
  *tmp__15 = (llvm_xor_u8((llvm_and_u8((((int)tmp__30)), 1)), 1));
  *tmp__16 = (llvm_and_u8((((int)(llvm_lshr_u32((tmp__35 ^ tmp__34), 4)))), 1));
  *tmp__17 = 0;
  *tmp__19 = (((int)tmp__36));
  *tmp__21 = (((int)(int)((((llvm_add_u32((tmp__36 ^ tmp__37), tmp__37)) == 2u)&1))));
  *tmp__5 = (0UL);
  tmp__31 = *(((int*)tmp__24));
  *tmp__7 = tmp__31;
  tmp__32 = *(((int*)(llvm_add_u64(tmp__24, (8UL)))));
  *tmp__8 = tmp__32;
  *tmp__6 = (llvm_add_u64(tmp__24, (16UL)));
  return tmp__33;
  do {     /* Syntactic loop 'block_40114a' to make GCC happy */
block_40114a:
  tmp__33 = tmp__33__PHI_TEMPORARY;
  tmp__34 = *(((int*)tmp__27));
  tmp__35 = llvm_add_u32(tmp__34, -39);
  tmp__36 = llvm_lshr_u32(tmp__35, 31);
  tmp__37 = llvm_lshr_u32(tmp__34, 31);
  if (((((((tmp__35 == 0u)&1)) | ((((((tmp__36 != 0u)&1)) ^ ((((llvm_add_u32((tmp__36 ^ tmp__37), tmp__37)) == 2u)&1)))&1)))&1))) {
    goto block_40113a;
  } else {
    goto block_401150;
  }
...
block_40113a:
  tmp__29 = *(((int*)tmp__25));
  if ((((tmp__29 == 0u)&1))) {
    tmp__39__PHI_TEMPORARY = tmp__34;   /* for PHI node */
    tmp__40__PHI_TEMPORARY = tmp__27;   /* for PHI node */
    goto block_40114a_2e_backedge;
  } else {
    goto block_401146;
  }
...
block_40114a_2e_backedge:
  tmp__39 = tmp__39__PHI_TEMPORARY;
  tmp__40 = tmp__40__PHI_TEMPORARY;
  *(((int*)tmp__40)) = (llvm_add_u32(tmp__39, 1));
  tmp__33__PHI_TEMPORARY = tmp__33;   /* for PHI node */
  goto block_40114a;

  } while (1); /* end of syntactic loop 'block_40114a' */
}


void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__41, int tmp__42, void* tmp__43) {
  int* tmp__44;
  int tmp__45;
  int* tmp__46;
  int tmp__47;
  ...
  tmp__44 = (&tmp__41->field6.field15.field0.field0);
  tmp__45 = *tmp__44;
  tmp__46 = (&tmp__41->field6.field13.field0.field0);
  tmp__47 = *tmp__46;
  tmp__48 = llvm_add_u64(tmp__47, (18446744073709551608UL));
  *(((int*)tmp__48)) = tmp__45;
  tmp__49 = *(((int*)tmp__48));
  *tmp__44 = tmp__49;
  tmp__50 = *(((int*)tmp__47));
  *((&tmp__41->field6.field33.field0.field0)) = tmp__50;
  *tmp__46 = (llvm_add_u64(tmp__47, (8UL)));
  return tmp__43;
}
