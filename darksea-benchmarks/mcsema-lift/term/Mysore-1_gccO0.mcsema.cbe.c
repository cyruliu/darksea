...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, int tmp__2, void* tmp__3) {
  ...
  *(((int*)tmp__32)) = tmp__33;
  tmp__35 = *(((int*)tmp__32));
  tmp__36 = llvm_add_u32(tmp__35, -1);
  *tmp__14 = (((int)(int)(((tmp__35 == 0u)&1))));
  tmp__37 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__36 & 255));
  *tmp__16 = (llvm_xor_u8((llvm_and_u8((((int)tmp__37)), 1)), 1));
  *tmp__17 = (llvm_and_u8((((int)(llvm_lshr_u32((tmp__36 ^ tmp__35), 4)))), 1));
  *tmp__18 = (((int)(int)(((tmp__36 == 0u)&1))));
  tmp__38 = llvm_lshr_u32(tmp__36, 31);
  tmp__39 = ((int)tmp__38);
  *tmp__20 = tmp__39;
  tmp__40 = llvm_lshr_u32(tmp__35, 31);
  *tmp__22 = (((int)(int)((((llvm_add_u32((tmp__38 ^ tmp__40), tmp__40)) == 2u)&1))));
  tmp__41 = (((((tmp__36 == 0u)&1)) | ((((((tmp__39 != ((int)0))&1)) ^ ((((llvm_add_u32((tmp__38 ^ tmp__40), tmp__40)) == 2u)&1)))&1)))&1);
  tmp__42 = llvm_add_u64((llvm_select_u64(tmp__41, (26UL), (2UL))), (llvm_add_u64(tmp__34, (7UL))));
  if (tmp__41) {
    tmp__48__PHI_TEMPORARY = tmp__30;   /* for PHI node */
    goto block_401155;
  } else {
    goto block_40113d;
  }
...
block_40113d:
  tmp__45 = llvm_add_u64(tmp__42, (12UL));
  tmp__46 = llvm_add_u64(tmp__31, (18446744073709551608UL));
  tmp__51__PHI_TEMPORARY = tmp__45;   /* for PHI node */
  tmp__52__PHI_TEMPORARY = tmp__30;   /* for PHI node */
  goto block_401149;

block_401155_2e_loopexit:
  *tmp__6 = (((int)(int)tmp__53));
  tmp__47 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__55 & 255));
  *tmp__14 = 0;
  *tmp__16 = (llvm_xor_u8((llvm_and_u8((((int)tmp__47)), 1)), 1));
  *tmp__18 = (((int)(int)(((tmp__55 == 0u)&1))));
  *tmp__20 = (((int)tmp__56));
  *tmp__22 = 0;
  *tmp__17 = 0;
  tmp__48__PHI_TEMPORARY = tmp__52;   /* for PHI node */
  goto block_401155;
...
block_401155:
  ...
  *tmp__5 = (0UL);
  tmp__49 = *(((int*)tmp__31));
  *tmp__8 = tmp__49;
  tmp__50 = *(((int*)(llvm_add_u64(tmp__31, (8UL)))));
  *tmp__9 = tmp__50;
...
block_401149:
  ...
  tmp__52 = tmp__52__PHI_TEMPORARY;
  tmp__53 = *(((int*)tmp__46));
  tmp__54 = *(((int*)tmp__32));
  tmp__55 = llvm_add_u32(tmp__53, tmp__54);
  tmp__56 = llvm_lshr_u32(tmp__55, 31);
  tmp__57 = llvm_add_u64((llvm_select_u64((((tmp__56 == 0u)&1)), (18446744073709551596UL), (2UL))), (llvm_add_u64(tmp__51, (10UL))));
  if ((((tmp__56 == 0u)&1))) {
    goto block_40113f;
  } else {
    goto block_401155_2e_loopexit;
  }

block_40113f:
  *(((int*)tmp__46)) = (llvm_sub_u32(tmp__53, tmp__54));
  tmp__43 = llvm_add_u64(tmp__57, (10UL));
  tmp__44 = *(((int*)tmp__32));
  *(((int*)tmp__32)) = (llvm_add_u32(tmp__44, 1));
  tmp__51__PHI_TEMPORARY = tmp__43;   /* for PHI node */
  tmp__52__PHI_TEMPORARY = tmp__52;   /* for PHI node */
  goto block_401149;
...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__58, int tmp__59, void* tmp__60) {
  int* tmp__61;
  int tmp__62;
  int* tmp__63;
  int tmp__64;
  ...
  tmp__61 = (&tmp__58->field6.field15.field0.field0);
  tmp__62 = *tmp__61;
  tmp__63 = (&tmp__58->field6.field13.field0.field0);
  tmp__64 = *tmp__63;
  tmp__65 = llvm_add_u64(tmp__64, (18446744073709551608UL));
  *(((int*)tmp__65)) = tmp__62;
  tmp__66 = *(((int*)tmp__65));
  *tmp__61 = tmp__66;
  tmp__67 = *(((int*)tmp__64));
  *((&tmp__58->field6.field33.field0.field0)) = tmp__67;
  *tmp__63 = (llvm_add_u64(tmp__64, (8UL)));
  return tmp__60;
}
