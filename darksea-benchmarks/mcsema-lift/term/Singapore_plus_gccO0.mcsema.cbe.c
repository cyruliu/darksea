...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, int tmp__2, void* tmp__3) {
  ...
  *tmp__6 = (((int)(int)tmp__36));
  tmp__37 = *(((int*)tmp__32));
  tmp__38 = llvm_add_u32(tmp__36, tmp__37);
  *tmp__14 = 0;
  tmp__39 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__38 & 255));
  *tmp__16 = (llvm_xor_u8((llvm_and_u8((((int)tmp__39)), 1)), 1));
  *tmp__18 = (((int)(int)(((tmp__38 == 0u)&1))));
  tmp__40 = ((int)(llvm_lshr_u32(tmp__38, 31)));
  *tmp__20 = tmp__40;
  *tmp__22 = 0;
  *tmp__17 = 0;
  tmp__41 = llvm_add_u64((llvm_select_u64((((tmp__40 == ((int)0))&1)), (2UL), (28UL))), (llvm_add_u64(tmp__34, (13UL))));
  if ((((tmp__40 == ((int)1))&1))) {
  ...
  do {     /* Syntactic loop 'block_401157' to make GCC happy */
block_401157:
  tmp__42 = tmp__42__PHI_TEMPORARY;
  tmp__43 = tmp__43__PHI_TEMPORARY;
  tmp__44 = *(((int*)tmp__35));
  tmp__45 = llvm_lshr_u32(tmp__44, 31);
  tmp__46 = llvm_add_u64((llvm_select_u64(((((llvm_or_u8((((int)(int)(((tmp__44 == 0u)&1)))), (((int)tmp__45)))) == ((int)0))&1)), (18446744073709551594UL), (2UL))), (llvm_add_u64(tmp__42, (4UL))));
  if (((((llvm_or_u8((((int)(int)(((tmp__44 == 0u)&1)))), (((int)tmp__45)))) == ((int)0))&1))) {
    goto block_401145;
  } else {
    goto block_40115d_2e_loopexit;
  }

block_401145:
  tmp__47 = (((int)(int)tmp__44)) << (1UL);
  *tmp__6 = (tmp__47 & (4294967294UL));
  tmp__48 = *(((int*)tmp__32));
  *(((int*)tmp__35)) = (llvm_add_u32(tmp__48, (((int)tmp__47))));
  tmp__49 = llvm_add_u64(tmp__46, (18UL));
  tmp__50 = *(((int*)tmp__32));
  *(((int*)tmp__32)) = (llvm_add_u32(tmp__50, 1));
  tmp__42__PHI_TEMPORARY = tmp__49;   /* for PHI node */
  tmp__43__PHI_TEMPORARY = tmp__43;   /* for PHI node */
  goto block_401157;

  } while (1); /* end of syntactic loop 'block_401157' */
block_40115d_2e_loopexit:
  tmp__51 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__44 & 255));
  *tmp__14 = 0;
  *tmp__16 = (llvm_xor_u8((llvm_and_u8((((int)tmp__51)), 1)), 1));
  *tmp__17 = 0;
  *tmp__18 = (((int)(int)(((tmp__44 == 0u)&1))));
  *tmp__20 = (((int)tmp__45));
  *tmp__22 = 0;
  tmp__52__PHI_TEMPORARY = tmp__43;   /* for PHI node */
  goto block_40115d;
...
block_40115d:
  ...
  *tmp__5 = (0UL);
  tmp__53 = *(((int*)tmp__31));
  *tmp__8 = tmp__53;
  tmp__54 = *(((int*)(llvm_add_u64(tmp__31, (8UL)))));
  *tmp__9 = tmp__54;
  *tmp__7 = (llvm_add_u64(tmp__31, (16UL)));
  return tmp__52;
block_401143:
  tmp__55 = llvm_add_u64(tmp__41, (20UL));
  tmp__42__PHI_TEMPORARY = tmp__55;   /* for PHI node */
  tmp__43__PHI_TEMPORARY = tmp__30;   /* for PHI node */
  goto block_401157;

}


void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__56, int tmp__57, void* tmp__58) {
  int* tmp__59;
  int tmp__60;
  int* tmp__61;
  int tmp__62;
  ...
  tmp__59 = (&tmp__56->field6.field15.field0.field0);
  tmp__60 = *tmp__59;
  tmp__61 = (&tmp__56->field6.field13.field0.field0);
  tmp__62 = *tmp__61;
  tmp__63 = llvm_add_u64(tmp__62, (18446744073709551608UL));
  *(((int*)tmp__63)) = tmp__60;
  tmp__64 = *(((int*)tmp__63));
  *tmp__59 = tmp__64;
  tmp__65 = *(((int*)tmp__62));
  *((&tmp__56->field6.field33.field0.field0)) = tmp__65;
  *tmp__61 = (llvm_add_u64(tmp__62, (8UL)));
  return tmp__58;
}
