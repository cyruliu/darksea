...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, int tmp__2, void* tmp__3) {
  ...
  *tmp__7 = tmp__29;
  ...
  tmp__33 = *EAX;
  *(((int*)tmp__32)) = tmp__33;
  tmp__34 = llvm_add_u64(tmp__31, (18446744073709551612UL));
  tmp__37__PHI_TEMPORARY = tmp__30;   /* for PHI node */
  goto block_401151;

  do {     /* Syntactic loop 'block_401151' to make GCC happy */
block_401151:
  tmp__37 = tmp__37__PHI_TEMPORARY;
  tmp__38 = *(((int*)tmp__34));
  tmp__39 = llvm_lshr_u32(tmp__38, 31);
  if ((((tmp__39 == 0u)&1))) {
    goto block_401139;
  } else {
    goto block_401157;
...
block_401139:
  tmp__35 = *(((int*)tmp__32));
  *(((int*)tmp__34)) = (llvm_add_u32(tmp__35, tmp__38));
  tmp__36 = *(((int*)tmp__32));
  *tmp__6 = (((int)(int)tmp__36));
  *(((int*)tmp__32)) = (~((tmp__36 << 1)));
  tmp__37__PHI_TEMPORARY = tmp__37;   /* for PHI node */
  goto block_401151;

  } while (1); /* end of syntactic loop 'block_401151' */
block_401157:
  tmp__40 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__38 & 255));
  *tmp__14 = 0;
  *tmp__16 = (llvm_xor_u8((llvm_and_u8((((int)tmp__40)), 1)), 1));
  *tmp__17 = 0;
  ...
  *tmp__5 = (0UL);
  tmp__41 = *(((int*)tmp__31));
  *tmp__8 = tmp__41;
  tmp__42 = *(((int*)(llvm_add_u64(tmp__31, (8UL)))));
  *tmp__9 = tmp__42;
...
void* sub_401106___VERIFIER_nondet_int(struct l_struct_struct_OC_State* tmp__43, int tmp__44, void* tmp__45) {
  int* tmp__46;
  int tmp__47;
  int* tmp__48;
  int tmp__49;
  ...
  tmp__46 = (&tmp__43->field6.field15.field0.field0);
  tmp__47 = *tmp__46;
  tmp__48 = (&tmp__43->field6.field13.field0.field0);
  tmp__49 = *tmp__48;
  tmp__50 = llvm_add_u64(tmp__49, (18446744073709551608UL));
  *(((int*)tmp__50)) = tmp__47;
  tmp__51 = *(((int*)tmp__50));
  *tmp__46 = tmp__51;
  tmp__52 = *(((int*)tmp__49));
  *((&tmp__43->field6.field33.field0.field0)) = tmp__52;
  *tmp__48 = (llvm_add_u64(tmp__49, (8UL)));
  return tmp__45;
}
