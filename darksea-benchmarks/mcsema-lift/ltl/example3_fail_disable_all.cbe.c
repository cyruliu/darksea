...
void* sub_8048380___VERIFIER_error(struct l_struct_struct_OC_State*, unsigned int, void*) ;
...
void* sub_8048380___VERIFIER_error(struct l_struct_struct_OC_State* tmp__1, unsigned int tmp__2, void* tmp__3) {
  __VERIFIER_error();
  error = 1;
  unsigned int* tmp__4;
  unsigned int* tmp__5;
...
void* dummy_main(struct l_struct_struct_OC_State* tmp__13, unsigned int tmp__14, void* tmp__15) {
  ...
  unsigned int tmp__31__PHI_TEMPORARY;
  unsigned int tmp__32;
  unsigned int tmp__32__PHI_TEMPORARY;
  void* tmp__33;
  void* tmp__33__PHI_TEMPORARY;
  ...
  tmp__19 = *((unsigned int*)(((unsigned int)(((unsigned int)((unsigned int)(&seg_804964c__bss))) + ((unsigned int)8)))));
  *((&tmp__13->field6.field7.field0.field0)) = tmp__19;
  *((&tmp__13->field6.field1.field0.field0)) = 0;
  tmp__20 = *tmp__17;
  tmp__21 = *tmp__16;
  tmp__22 = llvm_add_u32(tmp__21, -4);
  tmp__23 = (&tmp__13->field5.field1.field0.field0);
  tmp__24 = *tmp__23;
  tmp__25 = ((unsigned int*)(llvm_add_u32(tmp__24, tmp__22)));
  *tmp__25 = tmp__20;
  *tmp__17 = tmp__22;
  *((&tmp__13->field2.field1)) = 0;
  tmp__26 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__19 & 255));
  *((&tmp__13->field2.field3)) = (llvm_xor_u8((llvm_and_u8((((unsigned char)tmp__26)), 1)), 1));
  *((&tmp__13->field2.field7)) = (((unsigned char)(char)(((tmp__19 == 0u)&1))));
  *((&tmp__13->field2.field9)) = (((unsigned char)(llvm_lshr_u32(tmp__19, 31))));
  *((&tmp__13->field2.field13)) = 0;
  *((&tmp__13->field2.field5)) = 0;
  if ((((tmp__19 == 0u)&1))) {
    goto block_804839f;
  } else {
    _2e_pre_2d_phi__PHI_TEMPORARY = tmp__25;   /* for PHI node */
    tmp__31__PHI_TEMPORARY = tmp__24;   /* for PHI node */
    tmp__32__PHI_TEMPORARY = tmp__22;   /* for PHI node */
    tmp__33__PHI_TEMPORARY = tmp__15;   /* for PHI node */
    goto block_80483a4;
  }

block_804839f:
  tmp__27 = llvm_add_u32(tmp__21, -8);
  *(((unsigned int*)(llvm_add_u32(tmp__24, tmp__27)))) = (llvm_add_u32(tmp__14, 20));
  *tmp__16 = tmp__27;
  tmp__28 =  /*tail*/ sub_8048380___VERIFIER_error(tmp__13, /*UNDEF*/0, tmp__15);
  tmp__29 = *tmp__16;
  tmp__30 = *tmp__23;
  _2e_pre = ((unsigned int*)(llvm_add_u32(tmp__30, tmp__29)));
  _2e_pre_2d_phi__PHI_TEMPORARY = _2e_pre;   /* for PHI node */
  tmp__31__PHI_TEMPORARY = tmp__30;   /* for PHI node */
  tmp__32__PHI_TEMPORARY = tmp__29;   /* for PHI node */
  tmp__33__PHI_TEMPORARY = tmp__28;   /* for PHI node */
  goto block_80483a4;
...
block_80483a4:
  ...
  tmp__33 = tmp__33__PHI_TEMPORARY;
  tmp__34 = *_2e_pre_2d_phi;
  *tmp__17 = tmp__34;
  tmp__35 = *(((unsigned int*)(llvm_add_u32((llvm_add_u32(tmp__31, 4)), tmp__32))));
  *tmp__18 = tmp__35;
  *tmp__16 = (llvm_add_u32(tmp__32, 8));
  return tmp__33;
}
