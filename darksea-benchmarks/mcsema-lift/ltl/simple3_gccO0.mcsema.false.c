...
void* sub_401111_main(struct l_struct_struct_OC_State* tmp__1, unsigned long tmp__2, void* tmp__3) {
  ...
  *(((unsigned long*)tmp__11)) = tmp__9;
  *tmp__7 = tmp__11;
  tmp__12 = llvm_add_u64(tmp__10, (18446744073709551592UL));
  tmp__13 = (&tmp__1->field2.field1);
  *tmp__13 = (((unsigned char)(char)(((((unsigned long)tmp__11) < ((unsigned long)(16UL)))&1))));
  tmp__14 =  /*tail*/ llvm_OC_ctpop_OC_i32(((((unsigned int)tmp__12)) & 255));
  tmp__15 = (&tmp__1->field2.field3);
  *tmp__15 = (llvm_xor_u8((llvm_and_u8((((unsigned char)tmp__14)), 1)), 1));
  tmp__16 = (&tmp__1->field2.field5);
  *tmp__16 = (llvm_and_u8((((unsigned char)(llvm_lshr_u64(((tmp__11 ^ (16UL)) ^ tmp__12), (4UL))))), 1));
  tmp__17 = (&tmp__1->field2.field7);
  *tmp__17 = (((unsigned char)(char)(((tmp__12 == (0UL))&1))));
  tmp__18 = llvm_lshr_u64(tmp__12, (63UL));
  tmp__19 = (&tmp__1->field2.field9);
  *tmp__19 = (((unsigned char)tmp__18));
  tmp__20 = llvm_lshr_u64(tmp__11, (63UL));
  tmp__21 = (&tmp__1->field2.field13);
  *tmp__21 = (((unsigned char)(char)((((llvm_add_u64((tmp__18 ^ tmp__20), tmp__20)) == (2UL))&1))));
  *((unsigned int*)(&p)) = 0;
  *tmp__5 = (0UL);
  tmp__22 = llvm_add_u64(tmp__10, (18446744073709551584UL));
  *(((unsigned long*)tmp__22)) = (llvm_add_u64(tmp__2, (32UL)));
  *tmp__6 = tmp__22;
  tmp__23 =  /*tail*/ sub_401106___VERIFIER_nondet_int(tmp__1, /*UNDEF*/(0UL), tmp__3);
  tmp__24 = *tmp__7;
  tmp__25 = llvm_add_u64(tmp__24, (18446744073709551612UL));
  tmp__26 = *(((unsigned int*)tmp__4));
  *(((unsigned int*)tmp__25)) = tmp__26;
  tmp__27__PHI_TEMPORARY = tmp__23;   /* for PHI node */
  goto block_40113a;

  do {     /* Syntactic loop 'block_40113a' to make GCC happy */
block_40113a:
  tmp__27 = tmp__27__PHI_TEMPORARY;
  tmp__28 = *(((unsigned int*)tmp__25));
  tmp__29 = llvm_lshr_u32(tmp__28, 31);
  if (((((llvm_or_u8((((unsigned char)(char)(((tmp__28 == 0u)&1)))), (((unsigned char)tmp__29)))) == ((unsigned char)0))&1))) {
    goto block_401136;
  } else {
    goto block_401140;
  }
...
block_401136:
  *(((unsigned int*)tmp__25)) = (llvm_add_u32(tmp__28, -1));
  tmp__27__PHI_TEMPORARY = tmp__27;   /* for PHI node */
  goto block_40113a;

  } while (1); /* end of syntactic loop 'block_40113a' */
block_401140:
  tmp__30 =  /*tail*/ llvm_OC_ctpop_OC_i32((tmp__28 & 255));
  *tmp__13 = 0;
  *tmp__15 = (llvm_xor_u8((llvm_and_u8((((unsigned char)tmp__30)), 1)), 1));
  *tmp__16 = 0;
  *tmp__17 = (((unsigned char)(char)(((tmp__28 == 0u)&1))));
  *tmp__19 = (((unsigned char)tmp__29));
  *tmp__21 = 0;
  *((unsigned int*)(&p)) = 1;
  *tmp__5 = (0UL);
  tmp__31 = *(((unsigned long*)tmp__24));
  *tmp__7 = tmp__31;
  tmp__32 = *(((unsigned long*)(llvm_add_u64(tmp__24, (8UL)))));
  *tmp__8 = tmp__32;
