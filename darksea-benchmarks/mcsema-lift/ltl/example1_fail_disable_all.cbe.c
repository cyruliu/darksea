...
void* sub_80483b4___VERIFIER_error(struct l_struct_struct_OC_State*, unsigned int, void*) ;
...
void* sub_80483b4___VERIFIER_error(struct l_struct_struct_OC_State* tmp__1, unsigned int tmp__2, void* tmp__3) {
__VERIFIER_error();
 error = 1;
  unsigned int* tmp__4;
  unsigned int* tmp__5;
...
void* dummy_main(struct l_struct_struct_OC_State* tmp__13, unsigned int tmp__14, void* tmp__15) {
  ...
  tmp__16 = (&tmp__13->field6.field5.field0.field0);
  tmp__17 = (&tmp__13->field6.field7.field0.field0);
  tmp__18 = (&tmp__13->field6.field13.field0.field0);
  tmp__19 = (&tmp__13->field6.field15.field0.field0);
  tmp__20 = *tmp__18;
  tmp__21 = llvm_add_u32(tmp__20, 4);
  *tmp__16 = tmp__21;
  tmp__22 = tmp__20 & -16;
  tmp__23 = *(((unsigned int*)tmp__20));
  tmp__24 = (&tmp__13->field5.field1.field0.field0);
  tmp__25 = *tmp__24;
  tmp__26 = llvm_add_u32(tmp__25, tmp__22);
  *(((unsigned int*)(llvm_add_u32(tmp__26, -4)))) = tmp__23;
  tmp__27 = *tmp__19;
  tmp__28 = llvm_add_u32(tmp__22, -8);
  *(((unsigned int*)(llvm_add_u32(tmp__25, tmp__28)))) = tmp__27;
  *tmp__19 = tmp__28;
  *(((unsigned int*)(llvm_add_u32(tmp__26, -12)))) = tmp__21;
  *((unsigned int*)(((unsigned int)(((unsigned int)((unsigned int)(&seg_804a010__bss))) + ((unsigned int)8))))) = 0;
  *tmp__17 = 0;
  *((&tmp__13->field2.field1)) = 0;
  *((&tmp__13->field2.field3)) = 1;
  *((&tmp__13->field2.field7)) = 1;
  *((&tmp__13->field2.field9)) = 0;
  *((&tmp__13->field2.field13)) = 0;
  *((&tmp__13->field2.field5)) = 0;
  tmp__29 = llvm_add_u32(tmp__22, -16);
  *(((unsigned int*)(llvm_add_u32(tmp__25, tmp__29)))) = (llvm_add_u32(tmp__14, 38));
  *tmp__18 = tmp__29;
  tmp__30 =  /*tail*/ sub_80483b4___VERIFIER_error(tmp__13, /*UNDEF*/0, tmp__15);
  tmp__31 = *((&tmp__13->field6.field1.field0.field0));
  *tmp__17 = tmp__31;
  tmp__32 = *tmp__18;
  tmp__33 = *tmp__24;
  tmp__34 = llvm_add_u32(tmp__33, tmp__32);
  tmp__35 = *(((unsigned int*)tmp__34));
  *tmp__16 = tmp__35;
  tmp__36 = *(((unsigned int*)(llvm_add_u32(tmp__34, 4))));
  *tmp__19 = tmp__36;
  tmp__37 = *(((unsigned int*)(llvm_add_u32((llvm_add_u32(tmp__33, -4)), tmp__35))));
  *((&tmp__13->field6.field33.field0.field0)) = tmp__37;
  *tmp__18 = tmp__35;
  return tmp__30;
}
