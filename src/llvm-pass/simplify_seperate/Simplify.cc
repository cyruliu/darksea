...
struct simplifyReplaceMain : public ModulePass {

    static char ID;

    simplifyReplaceMain() : ModulePass(ID){}
...
struct simplifyReplaceArg : public ModulePass {

    static char ID;

    simplifyReplaceArg() : ModulePass(ID) {}
...
struct simplifyFlattenGPRs : public ModulePass{

    static char ID;

    simplifyFlattenGPRs() : ModulePass(ID) {}
...
struct simplifyBitCast : public ModulePass{
  /*
...
char simplifyReplaceMain::ID = 0;
static RegisterPass<simplifyReplaceMain> X("simplifyReplaceMain", "replace main function",
	false, true);

char simplifyReplaceArg::ID = 0;
static RegisterPass<simplifyReplaceArg> Y("simplifyReplaceArg", "replace arg with global struct",
	false, true);

char simplifyFlattenGPRs::ID = 0;
static RegisterPass<simplifyFlattenGPRs> Z("simplifyFlattenGPRs", "flatten gprs",
	false, true);

char simplifyBitCast::ID = 0;
static RegisterPass<simplifyBitCast> M("simplifyBitCast", "simplify bit cast instruction",
	false, true);
